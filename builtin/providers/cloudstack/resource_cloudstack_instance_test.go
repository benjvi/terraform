...
func TestAccCloudStackInstance_multiIP(t *testing.T) {
	var instance cloudstack.VirtualMachine
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCloudStackInstance_multiIP,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackInstanceExists(
						"cloudstack_instance.foobar", &instance),
					resource.TestCheckResourceAttr(
						"cloudstack_instance.foobar", "ip_to_network_list.0.ipaddress", CLOUDSTACK_NETWORK_1_IPADDRESS),
					resource.TestCheckResourceAttr(
						"cloudstack_instance.foobar", "ip_to_network_list.0.network", CLOUDSTACK_NETWORK_1),
					resource.TestCheckResourceAttr(
						"cloudstack_instance.foobar", "ip_to_network_list.1.ipaddress", CLOUDSTACK_NETWORK_2_IPADDRESS),
					resource.TestCheckResourceAttr(
						"cloudstack_instance.foobar", "ip_to_network_list.1.network", CLOUDSTACK_NETWORK_2),
				),
			},
		},
	})
...
func TestAccCloudStackInstance_multiNICWithoutIPs(t *testing.T) {
	var instance cloudstack.VirtualMachine
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCloudStackInstance_multiNICWithoutIPs,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackInstanceExists(
						"cloudstack_instance.foobar", &instance),
					resource.TestCheckResourceAttr(
						"cloudstack_instance.foobar", "ip_to_network_list.0.ipaddress", ""),
					resource.TestCheckResourceAttr(
						"cloudstack_instance.foobar", "ip_to_network_list.0.network", CLOUDSTACK_NETWORK_1),
					resource.TestCheckResourceAttr(
						"cloudstack_instance.foobar", "ip_to_network_list.1.ipaddress", ""),
					resource.TestCheckResourceAttr(
						"cloudstack_instance.foobar", "ip_to_network_list.1.network", CLOUDSTACK_NETWORK_2),
				),
			},
...
func TestAccCloudStackInstance_multiNICWithOneIP(t *testing.T) {
	var instance cloudstack.VirtualMachine
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCloudStackInstance_multiNICWithOneIP,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackInstanceExists(
						"cloudstack_instance.foobar", &instance),
					resource.TestCheckResourceAttr(
...
func TestAccCloudStackInstance_updateMultiIP_add(t *testing.T) {
	var instance cloudstack.VirtualMachine
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCloudStackInstance_singleNICWithIP,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackInstanceExists(
						"cloudstack_instance.foobar", &instance),
					resource.TestCheckResourceAttr(
...
var testAccCloudStackInstance_singleNICWithIP = fmt.Sprintf(`
resource "cloudstack_instance" "foobar" {
  name = "terraform-test"
  display_name = "terraform"
  service_offering = "%s"
...
var testAccCloudStackInstance_multiIP = fmt.Sprintf(`
resource "cloudstack_instance" "foobar" {
  name = "terraform-test"
  display_name = "terraform-multiIP"
  service_offering = "%s"
  ip_to_network_list = {
    network = "%s"
    ipaddress = "%s"
...
var testAccCloudStackInstance_multiNICWithoutIPs = fmt.Sprintf(`
resource "cloudstack_instance" "foobar" {
  name = "terraform-test"
  display_name = "terraform-multiNICWithoutIPs"
  service_offering = "%s"
  ip_to_network_list = {
    network = "%s"
    ipaddress = "0.0.0.0"
...
var testAccCloudStackInstance_multiNICWithOneIP = fmt.Sprintf(`
resource "cloudstack_instance" "foobar" {
  name = "terraform-test"
  display_name = "terraform-multiNICWithOneIP"
  service_offering = "%s"
  ip_to_network_list = {
    network = "%s"
    ipaddress = "0.0.0.0"
